...
2. What is an event?
An event is user interaction with the page elements. Clicking, mousing over, mousing out, and double clicking are some examples of events.

3. What is an event listener?
An event listener is added to an element in case it is clicked, hovered, or many other possible user interactions are made with the element. This allows for a specific style or attribute to be applied to the element itself, or can cause an other element to expand or collapse as an example.

4. Why would we convert a NodeList into an Array?
Arrays tend to be easier to access than NodeLists, and arrays can also be iterated through with forEach loops, while NodeLists cannot.

5. What is a component?
A componenet is a function that takes raw json data as an argument, and then converts those data values into usable html code.
